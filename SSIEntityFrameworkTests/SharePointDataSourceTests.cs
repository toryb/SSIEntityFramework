...
{
    [TestClass]
    public class SharePointDataSourceTests
    {
        ...
        public void ConnectTest()
        {
            ...
            //Connect
            SharePointDataSource spDS = new SharePointDataSource(entity);
            spDS.ConnectionString = @"https://halosystemsgh.sharepoint.com/SSIEntities/";
            spDS.AuthType = SharePointDataSource.AuthenticationType.User;
        ...
        /// <summary>
        ///  This test demonstrates connecting to a sharepoint site with an Add-In Principal without the need for a login screen.
        ///  The Client Id and Secret are usually stored in the app config of an assembly but it is supplied directly in this test.
        ///  For a tutorial on how to create an add-in principal that can be used in any domain see the following article:
        ///  https://www.codeproject.com/articles/1034444/access-office-using-a-console-application
        /// </summary>
        [TestMethod]
        public void ConnectWithAddInPrinicipalTest()
        {
            Entity entity = NewEntity();
            ...
            SharePointDataSource spDS = new SharePointDataSource(entity);
            spDS.ConnectionString = @"https://halosystemsgh.sharepoint.com/SSIEntities/";
            spDS.AuthType = SharePointDataSource.AuthenticationType.AddInPrincipal;
            spDS.ClientId = "8cac223a-3cdd-4993-99f1-fc9c6401d64d";
            spDS.ClientSecret = "nRKa6VFiwWTnV3cI8n53bM1KgLOc/nx13rxfEW/BQ4Y=";
            spDS.listName = "Entities";
            spDS.Connect();
            Assert.IsTrue(spDS.IsConnected());
        }
        ...
        /// <summary>
        /// Demonstrates connecting to a list that does not yet exist. List is created when the data source is disconnecting
        /// </summary>
        [TestMethod()]
        ...
        public void GetEntityInvalidIDTest()
        {
            ...
            // To do Why this block of code first?
            Entity newEntity = spDS.GetEntity(1);
            Assert.AreNotSame(entity, newEntity);
            Assert.AreEqual(entity.Name, newEntity.Name);
            Assert.AreEqual(entity.ID, newEntity.ID);
        ...
        public void DisconnectDeletedRecordsTest()
        {
            ...
            // check to make sure the entity exists in the "deleted" list
            SharePointDataSource spDeletedDS = new SharePointDataSource(entity);
            spDeletedDS.ConnectionString = @"https://halosystemsgh.sharepoint.com/SSIEntities/";
            spDeletedDS.UserName = "alex@halosystemsgh.onmicrosoft.com";
            spDeletedDS.Password = "UMUachala*32";
            spDeletedDS.AuthType = SharePointDataSource.AuthenticationType.User;
